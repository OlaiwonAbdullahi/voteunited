  ...
  return (
    <Link href={url}>
      ...
      >
        ...
        {/* Category Badge */}
        <Badge className={`${color} text-xs mb-3 rounded-full`}>
          {category}
        </Badge>
        ...
        <div className="inline-flex cursor-pointer items-center gap-2 text-primary hover:text-primary/80 font-semibold text-sm transition-all duration-200 group/link">
          Visit Resource
          <ExternalLink
            size={16}
